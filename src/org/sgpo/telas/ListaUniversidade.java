 ...
 * @author Fabio
 */
public class ListaUniversidade extends javax.swing.JInternalFrame {
     ...
     */
    public ListaUniversidade() {
        initComponents();
        conexao = ModuloConexao.conector();
    }
    
    private void pesquisaUniversidade1(){
        String sql ="select * from universidade where nome like ?";
        try {
            ...
            tabUniversidade.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
}
    
     private void pesquisaUniversidade2(){
        String sql ="select * from universidade where iduniversidade like ?";
        try {
            pst = conexao.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        tabUniversidade = new javax.swing.JTable();
        ...
        tabUniversidade.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tabUniversidade);
    ...
    private void txtPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisaKeyReleased
        ...
        if(comboPesquisa.getSelectedIndex() == 0){
            pesquisaUniversidade2();
        }else{
            pesquisaUniversidade1();
        }
    ...
    private javax.swing.JTable tabUniversidade;

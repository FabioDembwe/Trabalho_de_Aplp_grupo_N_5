 ...
 * @author Fabio
 */
public class ListaNotas extends javax.swing.JInternalFrame {
    ...
    private void pesquisaNotas1(){
        String sql ="select aluno.idaluno as ID_Aluno, aluno.nome as Nome, universidade.nome as Universidade, curso.nome as Curso,\n" +
"turma.nome as Turma, disciplina.nome as Disciplina, (sum(trabalho.nota)/count(idaluno))\n" +
"as 'MAC', (sum(prova.nota)/count(idaluno))  as \n" +
"'Média da Prova', ((sum(trabalho.nota)/count(idaluno)) * 0.60)+((sum(prova.nota)/count(idaluno))*0.40) as 'Média Final' \n" +
"from disciplina, universidade, turma, curso, prova, trabalho, aluno where idaluno like ?";
        try {
     ...
     private void pesquisaNotas2(){
        String sql ="select aluno.idaluno as ID_Aluno, aluno.nome as Nome, disciplina.nome as Disciplina, prova.nota as Nota  from disciplina, prova, aluno where aluno_idaluno = aluno.nome like ?";
        try {
            pst = conexao.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        tabNotas.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
